...
{% data reusables.pages.sidebar-pages %} 3. Under "{% data variables.product.prodname_pages %}," select **Enforce HTTPS**.
...
- If your site uses Jekyll, your HTML files will probably be found in the _\_layouts_ folder.
