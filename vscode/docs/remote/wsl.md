...
<table><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><thead><tr class="header"><th>Issue</th><th>Existing issues</th></tr></thead><tbody><tr class="odd"><td>Delve debugger doesn’t work under WSL</td><td><a href="https://github.com/go-delve/delve/issues/810">go-delve/delve#810</a>, <a href="https://github.com/microsoft/vscode-go/issues/926">Microsoft/vscode-go#926</a></td></tr></tbody></table>

### Node.js in WSL 1

<table><colgroup><col style="width: 50%" /><col style="width: 50%" /></colgroup><thead><tr class="header"><th>Issue</th><th>Existing issues</th></tr></thead><tbody><tr class="odd"><td>NodeJS Error: spawn EACCES (different variants of this error)</td><td><a href="https://github.com/microsoft/WSL/issues/3886">Microsoft/WSL#3886</a></td></tr><tr class="even"><td>Webpack HMR not working</td><td><a href="https://github.com/microsoft/WSL/issues/2709">Microsoft/WSL#2709</a></td></tr><tr class="odd"><td>Firebase via node unusably slow only on WSL</td><td><a href="https://github.com/microsoft/WSL/issues/2657">Microsoft/WSL#2657</a></td></tr></tbody></table>
