...
[Edit the Markdown file](https://github.com/expressjs/expressjs.com/blob/gh-pages/%7B%7B%20page.lang%20%7D%7D/resources/learning.md) and add a link to your book, then submit a pull request (GitHub login required). Follow the format of the above listings.
...
[Edit the Markdown file](https://github.com/expressjs/expressjs.com/blob/gh-pages/%7B%7B%20page.lang%20%7D%7D/resources/learning.md) and add a link to your blog, then submit a pull request (GitHub login required). Follow the format of the above listings.
