...
Extensions are made of different, but cohesive, components. Components can include [background scripts](/docs/extensions/mv2/background_pages/), [content scripts](/content_scripts), an [options page](/options), [UI elements](/user_interface) and various logic files. Extension components are created with web development technologies: HTML, CSS, and JavaScript. An extension’s components will depend on its functionality and may not require every option.

This tutorial will build an extension that allows the user to change the background color of any page on [developer.chrome.com](/docs/). It will use many core components to give an introductory demonstration of their relationships.
...
{% Img src=“image/BrQidfK9jaQyIHwdw91aVpkPiib2/iYdLKFsJ1KSVGLhbLRvS.png”, alt=“Load Extension”, height=“337”, width=“606” %}
...
Most APIs, including the [storage](/storage) API, must be registered under the `"permissions"` field in the manifest for the extension to use them.
...
{% Img src=“image/BrQidfK9jaQyIHwdw91aVpkPiib2/V96EHNVYQLVsjURz4Naz.png”, alt=“Inspect Views”, height=“337”, width=“606” %}
...
Like the background script, this file needs to be designated as a popup in the manifest under [`page_action`](/pageAction).
...
Designation for toolbar icons is also included under `page_action` in the `default_icons` field. Download the images folder [here](https://storage.googleapis.com/web-dev-uploads/file/WlD8wC6g8khYWPJUsQceQkhXSlv1/qwlTyQ1ah3RmqsgDhRkL.zip "images.zip"), unzip it, and place it in the extension’s directory. Update the manifest so the extension knows how to use the images.
...
Extensions also display images on the extension management page, the permissions warning, and favicon. These images are designated in the manifest under [`icons`](/user_interface#icons).
...
Add declared rules to the background script with the [`declarativeContent`](/declarativeContent) API within the `runtime.onInstalled` listener event.
...
The extension will need permission to access the [`declarativeContent`](/declarativeContent) API in its manifest.
...
{% Img src=“image/BrQidfK9jaQyIHwdw91aVpkPiib2/j3Ff3oF0tEl9tE5ed6L0.png”, alt=“Popup”, height=“99”, width=“73” %}
...
{% Img src=“image/BrQidfK9jaQyIHwdw91aVpkPiib2/3fNrYEoJMOPQ00L7tBtp.png”, alt=“Inspect Views”, height=“337”, width=“606” %}
...
{% Img src=“image/BrQidfK9jaQyIHwdw91aVpkPiib2/z1VEYxYlJev7llaXIQUL.png”, alt=“Extension Options”, height=“726”, width=“645” %}
