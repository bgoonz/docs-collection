...
{% Details %} {% DetailsSummary %} A brief summary goes here {% endDetailsSummary %}
...
{% Details %} {% DetailsSummary %} \#\#\# A normal heading goes here {% endDetailsSummary %}
...
{% Details %} {% DetailsSummary %} \#\#\# Details component summary This is an optional preview. {% endDetailsSummary %}
...
{% Aside %} Use the note aside to provide supplemental information. {% endAside %}
...
Here is a fancy [named markdown link](https://google.com). {% endAside %}
...
{% Aside ‘caution’ %} Use the caution aside to indicate a potential pitfall or complication. {% endAside %}
...
{% Aside ‘warning’ %} The warning aside is stronger than a caution aside; use it to tell the reader not to do something. {% endAside %}
...
{% Aside ‘success’ %} Use the success aside to describe a successful action or an error-free status. {% endAside %}
...
{% Aside ‘gotchas’ %} Use the gotchas aside to indicate a common problem that the reader wouldn’t know without specialized knowledge of the topic. {% endAside %}
...
{% Column %} {% Img src=“image/foR0vJZKULb5AGJExlazy1xYDgI2/iuwBXAyKJMz4b7oRyIdI.jpg”, alt=“ALT\_TEXT\_HERE”, width=“380”, height=“240” %} Original {% endColumn %}

{% Column %} {% Img src=“image/foR0vJZKULb5AGJExlazy1xYDgI2/iuwBXAyKJMz4b7oRyIdI.jpg”, alt=“ALT\_TEXT\_HERE”, width=“380”, height=“240”, params={flip: ‘h’} %} Flipped {% endColumn %}
...
{% Compare ‘better’ %} The right way to do something {% endCompare %}

{% Compare ‘worse’ %} Don’t do it this way! {% endCompare %}
...
{% Compare ‘worse’ %} Bad code example

{% CompareCaption %} Explanation of why example is **bad**. {% endCompareCaption %}

{% endCompare %}

{% Compare ‘better’ %} Good code example

{% CompareCaption %} Explanation of why example is **good**. {% endCompareCaption %}
...
{% Compare ‘worse’, ‘unhelpful’ %} Lorem ipsum dolor sit amet. {% endCompare %}

{% Compare ‘better’, ‘helpful’ %} Lorem ipsum dolor sit amet. {% endCompare %}
...
{% Glitch { id: ‘tabindex-zero’, path: ‘index.html’ } %}
...
{% Img src=“image/foR0vJZKULb5AGJExlazy1xYDgI2/w9i7lEqGw5J5b3jx5fAu.jpg”, alt=“ALT\_TEXT\_HERE”, width=“800”, height=“450” %}
...
{% Img class=“float-right”, src=“image/foR0vJZKULb5AGJExlazy1xYDgI2/w9i7lEqGw5J5b3jx5fAu.jpg”, alt=“ALT\_TEXT\_HERE”, width=“800”, height=“450” %}
...
<table><thead><tr class="header"><th>Person</th><th>Number</th><th>Third Column</th></tr></thead><tbody><tr class="odd"><td>Someone Lastname</td><td>900</td><td>Nullam</td></tr><tr class="even"><td><a href="#">Person Name</a></td><td>1200</td><td>Vestibulum</td></tr><tr class="odd"><td>Another Person</td><td>1500</td><td>Vivamus</td></tr><tr class="even"><td>Last One</td><td>2800</td><td>Morbi</td></tr></tbody></table>
...
{% Aside %} Note that the video `src` property can either be a string or an array of strings for multiple sources. {% endAside %}
