---json {"title":"PPB_FileIO Struct Reference"} ---
...
**Returns:**  
An int32_t containing an error code from `pp_errors.h`. PP_ERROR_FAILED will be returned if the file isn't opened, and PP_ERROR_INPROGRESS will be returned if there is another operation pending.
...
<a href="/docs/native-client/pepper_beta/c/struct_p_p_b___file_i_o__1__1#a85f0de223c9011c79df5b063ecd4a89f" class="el" title="ReadToArray() reads from an offset in the file.">ReadToArray()</a> reads from an offset in the file.
