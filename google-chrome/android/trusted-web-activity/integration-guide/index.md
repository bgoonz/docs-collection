...
required. This guide was created using _Android Studio 3.3_. Check the [docs on
...
The value for the _SHA-256 fingerprint_ is printed under the _Certificate_
...
and is equivalent to 320x320 **pixels** at the _mdpi_ density.
