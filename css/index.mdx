...
<Grid gridTemplateColumns={["1fr", "1fr", "repeat(3, 1fr)"]} gridGap={5} my={5}>
  {[
    ...
    {
      name: "Objects",
      description: "Scaffolding for common page and content layouts.",
      image: objectsImage,
    },
    {
      name: "Components",
      description: "Abstracted patterns for frequently used visual styles.",
...
<BorderBox bg="gray.1" p={5} mt={5}>
  ...
  <Text as="p" m={0}>
    Pick and choose what you need. Install the entire Primer CSS bundle or
