...
<details class="details-reset details-overlay" open>
  <summary class="btn" aria-haspopup="true">Choose an item</summary>
...
<div class="d-none d-sm-block" style="height: 120px">
  <!-- min height for > sm -->
</div>
```
...
<div class="d-sm-none" style="height: 600px"><!-- min height for < sm --></div>
<div class="d-none d-sm-block" style="height: 180px">
  <!-- min height for > sm -->
</div>
```
...
<details class="details-reset details-overlay" open>
  ...
  <div class="SelectMenu">
    <div class="SelectMenu-modal">
      ...
      <div class="SelectMenu-list">
        <button class="SelectMenu-item" role="menuitem">Text only</button>
        <button class="SelectMenu-item" role="menuitem">
          <!-- <%= octicon "pin", class: "SelectMenu-icon" %> -->
          <svg
            class="SelectMenu-icon octicon octicon-pin"
            viewBox="0 0 16 16"
            version="1.1"
            width="16"
            height="16"
        ...
        <button class="SelectMenu-item d-block" role="menuitem">
          With a <span class="Label">label</span>
        </button>
        <button class="SelectMenu-item" role="menuitem">
...
<div class="d-sm-none" style="height: 600px"><!-- min height for < sm --></div>
<div class="d-none d-sm-block" style="height: 320px">
  <!-- min height for > sm -->
</div>
```
...
<div class="d-sm-none" style="height: 600px"><!-- min height for < sm --></div>
<div class="d-none d-sm-block" style="height: 300px">
  <!-- min height for > sm -->
</div>
```
...
<div class="d-sm-none" style="height: 600px"><!-- min height for < sm --></div>
<div class="d-none d-sm-block" style="height: 260px">
  <!-- min height for > sm -->
</div>
```
...
<div class="d-sm-none" style="height: 600px"><!-- min height for < sm --></div>
<div class="d-none d-sm-block" style="height: 500px">
  <!-- min height for > sm -->
</div>
```
...
<div class="d-sm-none" style="height: 600px"><!-- min height for < sm --></div>
<div class="d-none d-sm-block" style="height: 380px">
  <!-- min height for > sm -->
</div>
```
...
<details class="details-reset details-overlay" open>
  ...
  <div class="SelectMenu">
    <div class="SelectMenu-modal">
      ...
      <div class="SelectMenu-list">
        <div class="SelectMenu-message color-bg-danger color-text-danger">
          Message goes here
        </div>
        <button class="SelectMenu-item" role="menuitem">Item 1</button>
        <button class="SelectMenu-item" role="menuitem">Item 2</button>
...
<details class="details-reset details-overlay" open>
  ...
  <div class="SelectMenu">
    <div class="SelectMenu-modal">
      <div class="SelectMenu-list">
        <button class="SelectMenu-item" role="menuitem">Item 1</button>
        <button class="SelectMenu-item" role="menuitem" disabled>
          Item 2 (disabled)
        </button>
        <a class="SelectMenu-item" role="menuitem" href="#">Item 3</a>
        <a class="SelectMenu-item" role="menuitem" aria-disabled="true"
          >Item 4 (disabled)</a
        >
      </div>
    </div>
...
<div class="d-sm-none" style="height: 600px"><!-- min height for < sm --></div>
<div class="d-none d-sm-block" style="height: 160px">
  <!-- min height for > sm -->
</div>
```
      ...
      <div class="SelectMenu-list">
        <div class="SelectMenu-blankslate">
          ...
          <svg
            ...
            height="32"
            viewBox="0 0 12 16"
            class="octicon octicon-repo color-gray-3"
            aria-hidden="true"
          >
            <path
              fill-rule="evenodd"
          ...
          <p class="mb-3 color-text-secondary">
