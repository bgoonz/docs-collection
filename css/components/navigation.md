...
<nav class="UnderlineNav" aria-label="Foo bar">
  <div class="UnderlineNav-body">
    <a class="UnderlineNav-item" href="#url" aria-current="page">
      ...
      <svg
        class="UnderlineNav-octicon octicon octicon-tools"
        version="1.1"
        width="16"
        height="16"
        viewBox="0 0 16 16"
...
<nav class="UnderlineNav UnderlineNav--full" aria-label="Foo bar">
  <div class="container-lg UnderlineNav-container">
    <div class="UnderlineNav-body">
      <a class="UnderlineNav-item" href="#url" aria-current="page">Item 1</a>
      <a class="UnderlineNav-item" href="#url"
        >Item 2<span class="Counter">10</span></a
      >
      <a class="UnderlineNav-item" href="#url">Item 3</a>
      <a class="UnderlineNav-item" href="#url">Item 4</a>
    </div>
...
```html live
<nav class="SideNav border" style="max-width: 360px">
  <a class="SideNav-item" href="#url"> Text only </a>
  ...
  <a class="SideNav-item" href="#url">
    ...
    <svg
      class="SideNav-icon octicon octicon-octoface"
      version="1.1"
      width="16"
      height="16"
      viewBox="0 0 16 16"
  ...
  <a
    class="SideNav-item d-flex flex-items-center flex-justify-between"
    href="#url"
  >
    With a status icon
...
<nav class="SideNav border" style="max-width: 360px">
  <a class="SideNav-item" href="#url">
    ...
    <svg
      class="octicon octicon-person SideNav-icon"
      width="12"
      height="16"
      viewBox="0 0 12 16"
      aria-hidden="true"
  ...
  <a class="SideNav-item" href="#url" aria-current="page">
    <!-- <%= octicon "octoface", class: "SideNav-icon" %> -->
    <svg
      class="octicon octicon-octoface SideNav-icon"
      width="16"
      height="16"
      viewBox="0 0 16 16"
      aria-hidden="true"
  ...
  <nav
    class="SideNav color-bg-primary border-top py-3"
  ...
  <a class="SideNav-item" href="#url">
    ...
    <svg
      class="octicon octicon-mail SideNav-icon"
      width="14"
      height="16"
      viewBox="0 0 14 16"
      aria-hidden="true"
    ...
    <a class="tabnav-tab" href="#url">
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M2.75 1.5C2.61193 1.5 2.5 1.61193 2.5 1.75V14.25C2.5 14.3881 2.61193 14.5 2.75 14.5H13.25C13.3881 14.5 13.5 14.3881 13.5 14.25V4.66421C13.5 4.59791 13.4737 4.53432 13.4268 4.48744L10.5126 1.57322C10.4657 1.52634 10.4021 1.5 10.3358 1.5H2.75ZM1 1.75C1 0.783502 1.7835 0 2.75 0H10.3358C10.7999 0 11.245 0.184374 11.5732 0.512563L14.4874 3.42678C14.8156 3.75497 15 4.20008 15 4.66421V14.25C15 15.2165 14.2165 16 13.25 16H2.75C1.7835 16 1 15.2165 1 14.25V1.75ZM8 3.25C8.41421 3.25 8.75 3.58579 8.75 4V5.5H10.25C10.6642 5.5 11 5.83579 11 6.25C11 6.66421 10.6642 7 10.25 7H8.75V8.5C8.75 8.91421 8.41421 9.25 8 9.25C7.58579 9.25 7.25 8.91421 7.25 8.5V7H5.75C5.33579 7 5 6.66421 5 6.25C5 5.83579 5.33579 5.5 5.75 5.5H7.25V4C7.25 3.58579 7.58579 3.25 8 3.25ZM5 11.25C5 10.8358 5.33579 10.5 5.75 10.5H10.25C10.6642 10.5 11 10.8358 11 11.25C11 11.6642 10.6642 12 10.25 12H5.75C5.33579 12 5 11.6642 5 11.25Z"
        ></path>
      </svg>
...
<ul class="filter-list">
  ...
  <li>
    <a class="filter-item" href="#url"> Third filter </a>
  </li>
</ul>
```
...
<div class="subnav">
  ...
  <div class="subnav-search float-left">
    ...
    <svg
      class="subnav-search-icon octicon octicon-search"
      width="16"
      height="16"
      viewBox="0 0 16 16"
      aria-hidden="true"
