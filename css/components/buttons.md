...
<div class="BtnGroup d-block mb-2">
  ...
  <button class="BtnGroup-item btn" type="button" aria-selected="true">
    Button
  </button>
...
<div class="BtnGroup d-block mb-2 ml-0">
  ...
  <button
    class="BtnGroup-item btn btn-outline"
    type="button"
    aria-selected="true"
  >
    Button
...
<button class="btn btn-primary mr-2" type="button" aria-disabled="true">
  Disabled
</button>
<button class="btn btn-outline mr-2" type="button" aria-disabled="true">
  Disabled
</button>
<button class="btn btn-danger" type="button" aria-disabled="true">
  Disabled
</button>
```
...
```html live
<div class="f3">
  <button class="btn btn-large btn-outline mr-2" type="button">
    Large button button
  </button>
...
<span class="hidden-text-expander">
  <button type="button" class="ellipsis-expander" aria-expanded="false">
    &hellip;
  </button>
</span>
```
