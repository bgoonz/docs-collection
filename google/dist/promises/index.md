...
## <a href="#javascript-promises:-an-introduction" class="w-toc__header--link">JavaScript Promises: an introduction</a>

- [What's all the fuss about?](#whats-all-the-fuss-about)
- [Events aren't always the best way](#events-aren't-always-the-best-way)
- [Promise terminology](#promise-terminology)
- [Promises arrive in JavaScript!](#promises-arrive-in-javascript!)
- [Browser support & polyfill](#browser-support-and-polyfill)
- [Compatibility with other libraries](#compatibility-with-other-libraries)
- [Complex async code made easier](#complex-async-code-made-easier)
- [Promisifying XMLHttpRequest](#promisifying-xmlhttprequest)
- [Chaining](#chaining)
- [Transforming values](#transforming-values)
- [Queuing asynchronous actions](#queuing-asynchronous-actions)
- [Error handling](#error-handling)
- [JavaScript exceptions and promises](#javascript-exceptions-and-promises)
- [Error handling in practice](#error-handling-in-practice)
- [Parallelism and sequencing: getting the best of both](#parallelism-and-sequencing:-getting-the-best-of-both)
- [Creating a sequence](#creating-a-sequence)
- [Bonus round: expanded capabilities](#bonus-round:-expanded-capabilities)
...
Dec 16, 2013 <span class="w-author__separator">•</span> Updated Jan 18, 2021
...
## What's all the fuss about? <a href="#whats-all-the-fuss-about" class="w-headline-link">#</a>
...
## Events aren't always the best way <a href="#events-aren&#39;t-always-the-best-way" class="w-headline-link">#</a>
...
## Promise terminology <a href="#promise-terminology" class="w-headline-link">#</a>
...
## Promises arrive in JavaScript! <a href="#promises-arrive-in-javascript!" class="w-headline-link">#</a>
...
## Browser support & polyfill <a href="#browser-support-and-polyfill" class="w-headline-link">#</a>
...
## Compatibility with other libraries <a href="#compatibility-with-other-libraries" class="w-headline-link">#</a>
...
## Complex async code made easier <a href="#complex-async-code-made-easier" class="w-headline-link">#</a>
...
## Promisifying XMLHttpRequest <a href="#promisifying-xmlhttprequest" class="w-headline-link">#</a>
...
## Chaining <a href="#chaining" class="w-headline-link">#</a>
...
### Transforming values <a href="#transforming-values" class="w-headline-link">#</a>
...
### Queuing asynchronous actions <a href="#queuing-asynchronous-actions" class="w-headline-link">#</a>
...
## Error handling <a href="#error-handling" class="w-headline-link">#</a>
...
### JavaScript exceptions and promises <a href="#javascript-exceptions-and-promises" class="w-headline-link">#</a>
...
### Error handling in practice <a href="#error-handling-in-practice" class="w-headline-link">#</a>
...
## Parallelism and sequencing: getting the best of both <a href="#parallelism-and-sequencing:-getting-the-best-of-both" class="w-headline-link">#</a>
...
### Creating a sequence <a href="#creating-a-sequence" class="w-headline-link">#</a>
...
## Bonus round: expanded capabilities <a href="#bonus-round:-expanded-capabilities" class="w-headline-link">#</a>

Since I originally wrote this article, the ability to use Promises has expanded greatly. Since Chrome 55, async functions have allowed promise-based code to be written as if it were synchronous, but without blocking the main thread. You can read more about that in [my async functions article](/async-functions). There's widespread support for both Promises and async functions in the major browsers. You can find the details in MDN's [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise) and [async function](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function) reference.
...
<span class="w-mr--sm"> Last updated: Jan 18, 2021 </span> [Improve article](https://github.com/GoogleChrome/web.dev/blob/master/src/site/content/en/blog/promises/index.md)
