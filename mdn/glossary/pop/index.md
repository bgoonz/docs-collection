--- title: POP3 slug: Glossary/POP tags: - Beginner - Glossary - Infrastructure ---

**POP3** (Post Office Protocol) is a very common {{glossary("protocol")}} for getting emails from a mail server over a {{glossary("TCP")}} connection. POP3 does not support folders, unlike the more recent {{Glossary("IMAP4")}}, which is harder to implement because of its more complex structure.
