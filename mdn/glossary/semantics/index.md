--- title: Semantics slug: Glossary/Semantics tags: - CodingScripting - Glossary - HTML - semantics ---

<span class="seoSummary">In programming, **Semantics** refers to the _meaning_ of a piece of code — for example "what effect does running that line of JavaScript have?", or "what purpose or role does that HTML element have" (rather than "what does it look like?".)</span>
