--- title: Certificate authority slug: Glossary/Certificate\_authority tags: - Cryptography - Glossary - Security ---

<span class="seoSummary">A certificate authority (CA) is an organization that {{Glossary("Signature/Security", "signs")}} {{Glossary("Digital certificate", "digital certificates")}} and their associated {{Glossary("Key", "public keys")}}, thereby asserting that the contained information and keys are correct.</span> 
