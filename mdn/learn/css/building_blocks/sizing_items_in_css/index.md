...
If you instead use `max-width: 100%`, and its intrinsic width was greater than its container, the image is able to become smaller than its container size, and will stop at 100% of its container size.
