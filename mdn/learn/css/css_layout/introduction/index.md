...
**Note**: These two examples are just a small part of the power of Grid layout; to find out more see our [Grid Layout](/en-US/docs/Learn/CSS/CSS_layout/Grids) article.
...
{{ EmbedLiveSample('Absolute\_1', '100%', 300) }}
