...
However, this URL is the old location of the page. If you enter it in a new browser tab, you’ll (eventually) get redirected to [https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch](/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch).
