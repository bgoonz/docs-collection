GraphQL has been released only as a _specification_. This means that GraphQL is in fact not more than a [long document](https://graphql.org/) that describes in detail the behaviour of a _GraphQL server._
